...
class IbisConnection(BaseConnection[BaseBackend]):
    ...
    def create_table(_self, *args, **kwargs) -> list[str]:
        return _self._instance.create_table(*args, **kwargs)
        
    def disconnect(_self, *args, **kwargs) -> list[str]:
        return _self._instance.disconnect(force = True, *args, **kwargs) 

...
message_landing = """
	...
	The desktop version allows you to process unlimited text and save processed corpora for future analysis.
	Users with more experience can download (from the GitHub repository linked at the top of this page) and run the **streamlit** app locally using Python.
	To get started:

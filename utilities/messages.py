...
# Static messages that populate the apps.
...
message_plotting = """
	...
	* Highlight in PCA scatterplots if you have loaded metadata.\n
	:triangular_ruler: If you choose to **scale** frequencies or use **tf-idf**, options are restricted to PCA.
	"""

...
message_load_target_external = """
    ###### :material/widgets: Use the widget to select the corpus \
    you'd like to load, either by browsing for them or dragging-and-dropping.
...
message_load_target_new = """
    ###### :material/widgets: Use the widget to select the files \
    ...
    :material/priority:
    Don't forget to select your model from the sidebar
    if you are processing a new corpus.
...
message_load_reference = """
    ###### :material/widgets: Use the widget \
    to select the files you'd like process, \
    either by browsing for them or dragging-and-dropping.

    :material/ads_click:
    Once you've selected your files, click the **UPLOAD**

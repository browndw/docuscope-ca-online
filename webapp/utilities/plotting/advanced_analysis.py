...
def generate_scatterplot(
    ...
    if df is None or df.is_empty():
        st.session_state[user_session_id][ScatterplotKeys.WARNING] = (
            "No data available for plotting. Please process your corpus and select valid tags.",
            ":material/info:"
        )
        return
    ...
    try:
        ...
        # Store the processed dataframe for plotting
        st.session_state[user_session_id][ScatterplotKeys.TARGET_SCATTER_DF[0]][ScatterplotKeys.TARGET_SCATTER_DF[1]] = df_plot
